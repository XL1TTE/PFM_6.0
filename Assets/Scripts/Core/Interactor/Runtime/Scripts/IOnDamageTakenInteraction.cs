...
{
    public interface IOnDamageTakenInteraction
    {
        UniTask Execute(
            Entity a_Source,
            Entity a_Target,
    ...
    public sealed class ShowFloatingDamageInteraction : BaseInteraction, IOnDamageTakenInteraction
    {
    ...
    public sealed class UpdateHealthBarInteraction : BaseInteraction, IOnDamageTakenInteraction, IOnEntityHealedInteraction
    {
    ...
    public sealed class CheckIfTargetHaveDiedInteraction : BaseInteraction, IOnDamageTakenInteraction
    {
