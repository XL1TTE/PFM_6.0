...
namespace Project
{
    ...
    public class CameraEdgePan : MonoBehaviour
    {
        ...
        /// <summary>
        /// Мгновенно проверяет и корректирует позицию камеры, если она вышла за границы
        /// </summary>
        /// <returns>True если позиция была скорректирована, false если камера уже в пределах границ</returns>
        public bool CheckAndEnforceBoundsImmediately()
        {
            ...
            // Если позиция изменилась - значит была за границами
            if (currentPosition != correctedPosition)
            {
                transform.position = correctedPosition;
                velocity = Vector3.zero; // Сбрасываем скорость для плавного движения
                return true;
            }
