...
namespace Gameplay.TurnSystem.Systems
{
    ...
    public sealed class TurnTakerAvatarDrawSystem : ISystem
    {
        ...
        {
            BattleUiRefs.Instance.BookWidget.m_Avatar.gameObject.SetActive(true);
        }

        private void HideAvatar()
        {
            BattleUiRefs.Instance.BookWidget.m_Avatar.gameObject.SetActive(false);
        }
        ...
        private void DrawCurrentTurnTakerAvatar()
        {
            ...
            if (avatar != null)
            {
                BattleUiRefs.Instance.BookWidget.m_Avatar.sprite = avatar;
            }
        }
